...
def post_build (target, toolchain, fsppkg, fsparch):
    ...
    cmd3 = [
           ...
           "<[0x0000]>+0x00B6, ([<[0x0000]>+0x00B6] & 0xFFFF0FF8) | 0x3000 | 0x000%d | 0x000%d | 0x0002,                           @FSP-V Component Attribute"  % (build_type, fsp_arch),
           ...
           "<[0x0000]>+0x00E0, FspSecCoreV:_FspValInitApi - [0x0000],                                                              @ValInit Entry",
           "<[0x0000]>+0x00E4, FspSecCoreV:_NotifyPhaseApi - [0x0000],                                                             @NotifyPhase API",
           "0x0000,            0x00000000,                                                                                         @Restore the value",
    ...
    cmd4 = [
         ...
         "<[0x0000]>+0x00B6, ([<[0x0000]>+0x00B6] & 0xFFFF0FF8) | 0x4000 | 0x000%d | 0x000%d | 0x0002,                           @FSP-S Component Attribute"  % (build_type, fsp_arch),
    ...
    for fspt, cmd in [('T', cmd1), ('M', cmd2), ('V', cmd3),('S',cmd4)]:
